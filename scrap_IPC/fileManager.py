...
class FileManager:
    ...
    url = ""
    folder = str(Path.cwd()) + "/scrap_IPC/files/xls"#path.cdw toma la ruta actual de trabajo//Se le agrega la carpeta en donde se va a guardad
    ...
    def downloadCSV(self):
        ...
        if response.status_code == 200:#Se verifica que el codigo sea de exito
            ...
            file_name = timestamp + ".xls" #Se crea el nombre
