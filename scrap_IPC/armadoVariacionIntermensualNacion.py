...
class armadoVariacionIntermensualNacion:
    def calculoVariacion(self, host, user, password, database):
        ...
        print("-----------------------------------------------")
        print("Se guardo los datos de Armado Variacion Intermensual del Total Nacion")
