...
class armadoVariacionIntermensualNacion:
    def calculoVariacion(self):
        ...
        select_dates_query = "SELECT Fecha FROM variacion_interanual_nacion"
