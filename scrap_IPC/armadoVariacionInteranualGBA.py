...
class armadoVariacionInteranualGBA:
    def calculoVariacion(self, host, user, password, database):
        ...
        # Obtener las fechas existentes en la tabla ipc_variacion_interanual_gba
        select_dates_query = "SELECT Fecha FROM ipc_variacion_interanual_gba"
        ...
        print("-----------------------------------------------")
        print("Se guardo los datos de Armado Variacion Interanual de GBA")
