...
class armadoVariacionIntermensualNoroeste:
    def calculoVariacion(self, host, user, password, database):
        ...
        # Obtener las fechas existentes en la tabla variacion_intermensual_noroeste
        select_dates_query = "SELECT Fecha FROM variacion_intermensual_noroeste"
