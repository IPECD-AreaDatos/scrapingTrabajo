...
class LoadXLSDataPampeana:
    def loadInDataBase(self, file_path):
        ...
        try:
            ...
            target_row_index = 65  # Índice de la línea específica que deseas obtener (por ejemplo, línea 3)
            ...
            nivel_general_values = sheet.row_values(69, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            alimento_y_bebidas_no_alcoholicas_values = sheet.row_values(70, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bebidas_alcoholicas_y_tabaco_values = sheet.row_values(71, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            prendasVestir_y_calzado_values = sheet.row_values(72, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles_values = sheet.row_values(73, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            equipamiento_y_mantenimiento_del_hogar_values = sheet.row_values(74, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Salud
            salud_values = sheet.row_values(75, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Transporte
            transporte_values = sheet.row_values(76, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Comunicación
            comunicación_values = sheet.row_values(77, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            recreación_y_cultura_values = sheet.row_values(78, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Educación
            educación_values = sheet.row_values(79, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            restaurantes_y_hoteles_values = sheet.row_values(80, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bienes_y_servicios_varios_values = sheet.row_values(81, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
