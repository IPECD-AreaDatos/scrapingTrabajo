...
class LoadXLSDataNoroeste:
    def loadInDataBase(self, file_path, host, user, password, database):
        ...
        try:
            ...
            # Obtener las fechas existentes en la tabla ipc_regionnoroeste
            select_dates_query = "SELECT Fecha FROM ipc_regionnoroeste"
            ...
            nivel_general = [cell.value for cell in sheet[99]][1:]
            alimento_y_bebidas_no_alcoholicas = [cell.value for cell in sheet[100]][1:]
            bebidas_alcoholicas_y_tabaco = [cell.value for cell in sheet[101]][1:]
            prendasVestir_y_calzado = [cell.value for cell in sheet[102]][1:]
            vivienda_agua_electricidad_gas_y_otros_combustibles = [cell.value for cell in sheet[103]][1:]
            equipamiento_y_mantenimiento_del_hogar = [cell.value for cell in sheet[104]][1:]
            salud = [cell.value for cell in sheet[105]][1:]
            transporte = [cell.value for cell in sheet[106]][1:]
            comunicación = [cell.value for cell in sheet[107]][1:]
            recreación_y_cultura = [cell.value for cell in sheet[108]][1:]
            educación = [cell.value for cell in sheet[109]][1:]
            restaurantes_y_hoteles = [cell.value for cell in sheet[110]][1:]
            bienes_y_servicios_varios = [cell.value for cell in sheet[111]][1:]
            ...
            print("-----------------------------------------------")
            print("Se guardaron los datos de IPC de la Region del Noroeste")
