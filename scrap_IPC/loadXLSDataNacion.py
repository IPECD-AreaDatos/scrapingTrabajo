...
class LoadXLSDataNacion:
    def loadInDataBase(self, file_path, host, user, password, database):
        ...
        try:
            ...
            # Obtener las fechas existentes en la tabla ipc_totalnacion
            select_dates_query = "SELECT Fecha FROM ipc_totalnacion"
            ...
            #Agregamos REGION - total nacion = 1
            
            update_query = "UPDATE ipc_totalnacion SET id_region = 1;"
            ...
            print("-----------------------------------------------")
            print("Se guardaron los datos de IPC del Total Nacion")
