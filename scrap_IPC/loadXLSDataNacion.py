...
class LoadXLSDataNacion:
    def loadInDataBase(self, file_path):
        ...
        try:
            ...
            target_row_index = 5  # Índice de la línea específica que deseas obtener (por ejemplo, línea 3)
            ...
            nivel_general_values = sheet.row_values(9, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            alimento_y_bebidas_no_alcoholicas_values = sheet.row_values(10, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bebidas_alcoholicas_y_tabaco_values = sheet.row_values(11, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            prendasVestir_y_calzado_values = sheet.row_values(12, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles_values = sheet.row_values(13, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            equipamiento_y_mantenimiento_del_hogar_values = sheet.row_values(14, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Salud
            salud_values = sheet.row_values(15, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Transporte
            transporte_values = sheet.row_values(16, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Comunicación
            comunicación_values = sheet.row_values(17, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            recreación_y_cultura_values = sheet.row_values(18, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Educación
            educación_values = sheet.row_values(19, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            restaurantes_y_hoteles_values = sheet.row_values(20, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bienes_y_servicios_varios_values = sheet.row_values(21, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            print("Se guardaron los datos del Nacion")
