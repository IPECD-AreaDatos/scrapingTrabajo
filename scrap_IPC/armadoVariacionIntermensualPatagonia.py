...
class armadoVariacionIntermensualPatagonia:
    def calculoVariacion(self, host, user, password, database):
        ...
        # Obtener las fechas existentes en la tabla ipc_variacion_intermensual_patagonia
        select_dates_query = "SELECT Fecha FROM ipc_variacion_intermensual_patagonia"
        ...
        print("-----------------------------------------------")
        print("Se guardo los datos de Armado Variacion Intermensual de la Region de la Patagonia")
