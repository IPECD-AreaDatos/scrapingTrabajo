...
class LoadXLSDataGBA:
    def loadInDataBase(self, file_path, valor_region, lista_fechas, lista_region,  lista_categoria, lista_division, lista_subdivision, lista_valores):
        ...
        try:
            ...
            target_row_index = 5  # El índice de la fila que deseas obtener (por ejemplo, línea 3)
            ...
            alimento_y_bebidas_no_alcoholicas = [cell.value for cell in sheet[8]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            alimento = [cell.value for cell in sheet[9]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            pan_y_cereales = [cell.value for cell in sheet[10]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            carnes_y_derivados = [cell.value for cell in sheet[11]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            leche_productoslacteos_huevos = [cell.value for cell in sheet[12]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            aceites_grasas_manteca = [cell.value for cell in sheet[13]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            frutas = [cell.value for cell in sheet[14]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            verduras_tuberculos_legumbres = [cell.value for cell in sheet[15]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            azucar_dulces_chocolate_golosinas = [cell.value for cell in sheet[16]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            bebidas_no_alcoholicas = [cell.value for cell in sheet[17]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            cafe_te_yerba_cacao = [cell.value for cell in sheet[18]][1:]
            ...
            #Agregamos Alimentos y bebidas no alcohólicas - Codigo 2
            aguas_minerales_bebidasgaseosas_jugos = [cell.value for cell in sheet[19]][1:]
            ...
            bebidas_alcoholicas_y_tabaco = [cell.value for cell in sheet[20]][1:]
            ...
            #Agregamos BEBIDAS ALCHOLICAS Y TABACOS - Codigo 3
            bebidas_alcoholicas= [cell.value for cell in sheet[21]][1:]
            ...
            #Agregamos BEBIDAS ALCHOLICAS Y TABACOS - Codigo 3
            tabaco= [cell.value for cell in sheet[22]][1:]
            ...
            prendasVestir_y_calzado = [cell.value for cell in sheet[23]][1:]
            ...
            #Agregamos Prendas de vestir y calzado - Codigo 4
            prendasdevestir_materiales = [cell.value for cell in sheet[24]][1:]
            ...
            #Agregamos Vivienda, agua, electricidad, gas y otros combustibles - Codigo  5         
            alquiler_vivienda_y_gastos_conexos = [cell.value for cell in sheet[27]][1:]
            ...
            #Agregamos Vivienda, agua, electricidad, gas y otros combustibles - Codigo  5         
            alquiler_vivienda = [cell.value for cell in sheet[28]][1:]
            ...
            #Agregamos Vivienda, agua, electricidad, gas y otros combustibles - Codigo  5         
            mantenimiento_y_reparacion_vivienda = [cell.value for cell in sheet[29]][1:]
            ...
            #Agregamos Vivienda, agua, electricidad, gas y otros combustibles - Codigo  5         
            electricidad_gas_otroscombustibles = [cell.value for cell in sheet[30]][1:]
            ...
            equipamiento_y_mantenimiento_del_hogar = [cell.value for cell in sheet[31]][1:]
            ...
            #Agregamos Equipamiento y mantenimiento del hogar - Codigo  6         
            bienesyservicios_para_la_conservacion_del_hogar = [cell.value for cell in sheet[32]][1:]
            ...
            salud = [cell.value for cell in sheet[33]][1:]
            ...
            #Agregamos salud - Codigo  7
            productos_medicinales_artefactos_equiposparalasalud = [cell.value for cell in sheet[34]][1:]
            ...
            #Agregamos salud - Codigo  7
            gastos_prepagas = [cell.value for cell in sheet[35]][1:]
            ...
            transporte = [cell.value for cell in sheet[36]][1:]
            ...
            #Agregamos Transporte - Codigo  8
            adquisicion_de_vehiculos = [cell.value for cell in sheet[37]][1:]
            ...
            #Agregamos Transporte - Codigo  8
            funcionamiento_equipos_transporte_personal = [cell.value for cell in sheet[38]][1:]
            ...
            #Agregamos Transporte - Codigo  8
            combustibles_lubricantes_vehiculos_hogar = [cell.value for cell in sheet[39]][1:]
            ...
            #Agregamos Transporte - Codigo  8
            transporte_publico = [cell.value for cell in sheet[40]][1:]
            ...
            comunicación = [cell.value for cell in sheet[41]][1:]
            ...
            #Agregamos Comunicacion - Codigo  9
            servicios_telefonia_internet = [cell.value for cell in sheet[42]][1:]
            ...
            recreación_y_cultura = [cell.value for cell in sheet[43]][1:]
            ...
            #Agregamos Recreación y cultura - Codigo  10
            equiposaudiovisuales_fotograficos_procesamientodelainformacion = [cell.value for cell in sheet[44]][1:]
            ...
            #Agregamos Recreación y cultura - Codigo  10
            servicios_recreativos_culturales = [cell.value for cell in sheet[45]][1:]
            ...
            #Agregamos Recreación y cultura - Codigo  10
            periodicos_diarios_revistas_libros_articulosdepapeleria = [cell.value for cell in sheet[46]][1:]
            ...
            educación = [cell.value for cell in sheet[47]][1:]
            ...
            restaurantes_y_hoteles = [cell.value for cell in sheet[48]][1:]
            ...
            #Agregamos Bienes y servicios varios - Codigo  13
            cuidado_personal = [cell.value for cell in sheet[51]][1:]
