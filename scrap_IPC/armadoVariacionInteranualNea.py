...
class armadoVariacionInteranualNEA:
    def calculoVariacion(self):
        ...
        # Obtener las fechas existentes en la tabla variacion_interanual_nea
        select_dates_query = "SELECT Fecha FROM variacion_interanual_nea"
