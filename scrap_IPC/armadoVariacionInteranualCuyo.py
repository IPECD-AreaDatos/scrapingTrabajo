...
class armadoVariacionInteranualCuyo:
    def calculoVariacion(self, host, user, password, database):
        ...
        # Obtener las fechas existentes en la tabla ipc_variacion_interanual_cuyo
        select_dates_query = "SELECT Fecha FROM ipc_variacion_interanual_cuyo"
        ...
        print("-----------------------------------------------")
        print("Se guardo los datos de Armado Variacion Interanual de la Region de Cuyo")
