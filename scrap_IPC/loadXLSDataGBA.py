...
class LoadXLSDataGBA:
    def loadInDataBase(self, file_path, host, user, password, database):
        ...
        try:
            ...
            # Obtener las fechas existentes en la tabla ipc_regiongba
            select_dates_query = "SELECT Fecha FROM ipc_regiongba"
