...
class LoadXLSDataCuyo:
    def loadInDataBase(self, file_path):
        ...
        try:
            ...
            target_row_index = 155  # Índice de la línea específica que deseas obtener (por ejemplo, línea 3)
            ...
            nivel_general_values = sheet.row_values(159, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            alimento_y_bebidas_no_alcoholicas_values = sheet.row_values(160, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bebidas_alcoholicas_y_tabaco_values = sheet.row_values(161, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            prendasVestir_y_calzado_values = sheet.row_values(162, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles_values = sheet.row_values(163, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            equipamiento_y_mantenimiento_del_hogar_values = sheet.row_values(164, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Salud
            salud_values = sheet.row_values(165, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Transporte
            transporte_values = sheet.row_values(166, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Comunicación
            comunicación_values = sheet.row_values(167, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            recreación_y_cultura_values = sheet.row_values(168, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Educación
            educación_values = sheet.row_values(169, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            restaurantes_y_hoteles_values = sheet.row_values(170, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bienes_y_servicios_varios_values = sheet.row_values(171, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
