...
class armadoVariacionInteranualPatagonia:
    def calculoVariacion(self, host, user, password, database):
        ...
        # Obtener las fechas existentes en la tabla variacion_interanual_patagonia
        select_dates_query = "SELECT Fecha FROM variacion_interanual_patagonia"
