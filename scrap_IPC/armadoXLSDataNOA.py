...
class LoadXLSDataNOA:
    def loadInDataBase(self, file_path, lista_fechas ,lista_region, valor_region ,lista_subdivision, lista_valores):
        ...
        try:
            ...
            nivel_general = list([cell.value for cell in sheet[99]][1:])
            ...
            alimento_y_bebidas_no_alcoholicas = list([cell.value for cell in sheet[100]][1:])
            ...
            bebidas_alcoholicas_y_tabaco = list([cell.value for cell in sheet[101]][1:])
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles = list([cell.value for cell in sheet[103]][1:])
            ...
            equipamiento_y_mantenimiento_del_hogar = list([cell.value for cell in sheet[104]][1:])
            ...
            salud = list([cell.value for cell in sheet[105]][1:])
            ...
            transporte = list([cell.value for cell in sheet[106]][1:])
            ...
            comunicación = list([cell.value for cell in sheet[107]][1:])
            ...
            recreación_y_cultura = list([cell.value for cell in sheet[108]][1:])
            ...
            educación = list([cell.value for cell in sheet[109]][1:])
            ...
            restaurantes_y_hoteles = list([cell.value for cell in sheet[110]][1:])
