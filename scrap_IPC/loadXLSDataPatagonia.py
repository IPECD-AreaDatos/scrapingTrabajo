...
class LoadXLSDataPatagonia:
    def loadInDataBase(self, file_path, host, user, password, database):
        ...
        try:
            ...
            nivel_general = [cell.value for cell in sheet[189]][1:]
            alimento_y_bebidas_no_alcoholicas = [cell.value for cell in sheet[190]][1:]
            bebidas_alcoholicas_y_tabaco = [cell.value for cell in sheet[191]][1:]
            prendasVestir_y_calzado = [cell.value for cell in sheet[192]][1:]
            vivienda_agua_electricidad_gas_y_otros_combustibles = [cell.value for cell in sheet[193]][1:]
            equipamiento_y_mantenimiento_del_hogar = [cell.value for cell in sheet[194]][1:]
            salud = [cell.value for cell in sheet[195]][1:]
            transporte = [cell.value for cell in sheet[196]][1:]
            comunicación = [cell.value for cell in sheet[197]][1:]
            recreación_y_cultura = [cell.value for cell in sheet[198]][1:]
            educación = [cell.value for cell in sheet[199]][1:]
            restaurantes_y_hoteles = [cell.value for cell in sheet[200]][1:]
