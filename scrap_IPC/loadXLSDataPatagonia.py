...
class LoadXLSDataPatagonia:
    def loadInDataBase(self, file_path):
        ...
        try:
            ...
            target_row_index = 185  # Índice de la línea específica que deseas obtener (por ejemplo, línea 3)
            ...
            nivel_general_values = sheet.row_values(189, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            alimento_y_bebidas_no_alcoholicas_values = sheet.row_values(190, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bebidas_alcoholicas_y_tabaco_values = sheet.row_values(191, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            prendasVestir_y_calzado_values = sheet.row_values(192, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles_values = sheet.row_values(193, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            equipamiento_y_mantenimiento_del_hogar_values = sheet.row_values(194, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Salud
            salud_values = sheet.row_values(195, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Transporte
            transporte_values = sheet.row_values(196, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Comunicación
            comunicación_values = sheet.row_values(197, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            recreación_y_cultura_values = sheet.row_values(198, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            #Educación
            educación_values = sheet.row_values(199, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            restaurantes_y_hoteles_values = sheet.row_values(200, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
            ...
            bienes_y_servicios_varios_values = sheet.row_values(201, start_colx=1)  # Supongamos que la nueva columna está en la fila 156
