...
"""
Este script saca los datos de la hoja de sheets: https://docs.google.com/spreadsheets/d/1L_EzJNED7MdmXw_rarjhhX8DpL7HtaKpJoRwyxhxHGI/edit#gid=0
De la hoja Semaforo
"""


class ExtractSheet: 
    def extract_sheet_internual(self):
        ...
        try:
            ...
            result = sheet.values().get(spreadsheetId=SPREADSHEET_ID, range='Semaforo!B2:12').execute()
            ...
            fila_fechas = sheet.values().get(spreadsheetId=SPREADSHEET_ID, range='Semaforo!B2:2').execute()
            ...
            df_semaforo['pasajeros_aeropuerto_corrientes'] = lista_sin_nulos[4]
            ...
            print(f"Error al extraer datos de Google Sheets: {e}")
            return None

    def extract_sheet_intermensual(self):
        ...
        #Realiza una llamada a la API para obtener datos desde la hoja 'Hoja 1' en el rango 'B2:12'
        result = sheet.values().get(spreadsheetId=SPREADSHEET_ID, range='Semaforo Intermensual!B2:12').execute()
        ...
        #Buscamos la fila de las fechas y obtenemos un diccionario
        fila_fechas = sheet.values().get(spreadsheetId=SPREADSHEET_ID, range='Semaforo Intermensual!B2:2').execute()
