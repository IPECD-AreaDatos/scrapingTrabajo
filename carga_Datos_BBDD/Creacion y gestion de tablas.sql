...
create table censo_sheets_ipecd(
	id_departamento INT,
    departamento VARCHAR(255),
    poblacion_2010 INT,
    poblacion_2022 INT,
    variacion_relativa FLOAT,
    densidad_habitantes_por_KM2 FLOAT,
    poblacion_2022_mujer_excluye_situacion_de_calle INT,
    poblacion_2022_varon_excluye_situacion_de_calle INT,
    indice_feminidad FLOAT,
    ...
    tasa_de_actividad FLOAT,
    categoria_ocupacional_servicio_domestico INT,
    categoria_ocupacional_empleado_u_obrero INT,
    categoria_ocupacional_cuenta_propia INT,
    categoria_ocupacional_patron_o_empleador INT,
    categoria_ocupacional_trabajador_familiar INT,
    categoria_ocupacional_ignorado INT,
    población_que_asiste_a_institución_educativa INT,
    población_que_no_asiste_pero_asistio_a_institución_educativa INT,
    población_que_nunca_asistio_a_institución_educativa INT,
    pob_en_viv_part_q_asis_a_esc_niv_educ_mat_guard_cen_cuid_sal_03 INT,
    pob_en_viv_part_que_asis_a_esc_niv_educ_sala_de_4_o_5 INT,
    pob_en_viv_part_que_asiste_a_escuelas_nivel_educ_primario INT,
    pob_en_viv_part_que_asiste_a_escuelas_nivel_educ_secundario INT,
    pob_en_viv_part_que_asis_a_esc_niv_educ_terciario_no_univers INT,
    pob_en_viv_part_que_asiste_a_esc_niv_educ_univ_de_grado INT,
    pob_en_viv_part_que_asiste_a_escuelas_nivel_educ_posgrado INT,
    mujeres_de_14_a_49_años_con_al_menos_1_hijo_nacido_vivo INT,
    promedio_de_hijos_por_mujer FLOAT,
    población_en_vivienda_obra_social_o_prepaga_incluye_PAMI INT,
    prueba_escala float,
    población_en_vivienda_programas_o_planes_estatales_de_salud INT,
    población_en_viv_no_tiene_obra_social_prepaga_ni_plan_estatal INT
)
