...
class readDataExcel:
    ...
    def _leer_excel(self, file_path, sheet_name, skiprows):
    ...
    def listado_provincias(self, file_path, lista_provincias, lista_valores_estacionalidad,
                        lista_valores_sin_estacionalidad, lista_registro, lista_fechas):
        try:
            df_estacional = self._leer_excel(file_path, sheet_name=13, skiprows=1)
            df_no_estacional = self._leer_excel(file_path, sheet_name=14, skiprows=1)
    ...
    def listado_nacion(self, file_path, lista_provincias, lista_valores_estacionalidad,
                       lista_valores_sin_estacionalidad, lista_registro, lista_fechas):
        try:
            df_estacional = self._leer_excel(file_path, sheet_name=3, skiprows=1)
            df_no_estacional = self._leer_excel(file_path, sheet_name=4, skiprows=1)
