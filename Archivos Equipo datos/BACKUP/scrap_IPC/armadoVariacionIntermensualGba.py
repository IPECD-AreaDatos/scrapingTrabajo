...
class armadoVariacionIntermensualGba:
    def calculoVariacion(self, host, user, password, database):
        ...
        # Obtener las fechas existentes en la tabla ipc_variacion_intermensual_gba
        select_dates_query = "SELECT Fecha FROM ipc_variacion_intermensual_gba"
