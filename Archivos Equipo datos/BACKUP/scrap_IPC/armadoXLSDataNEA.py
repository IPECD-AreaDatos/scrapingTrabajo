...
class LoadXLSDataNEA:
    def loadInDataBase(self, file_path, lista_fechas ,lista_region, valor_region ,lista_subdivision, lista_valores):
        ...
        try:
            ...
            nivel_general = list([cell.value for cell in sheet[129]][1:])
            ...
            alimento_y_bebidas_no_alcoholicas = list([cell.value for cell in sheet[130]][1:])
            ...
            bebidas_alcoholicas_y_tabaco = list([cell.value for cell in sheet[131]][1:])
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles = list([cell.value for cell in sheet[133]][1:])
            ...
            equipamiento_y_mantenimiento_del_hogar = list([cell.value for cell in sheet[134]][1:])
            ...
            salud = list([cell.value for cell in sheet[135]][1:])
            ...
            transporte = list([cell.value for cell in sheet[136]][1:])
            ...
            comunicación = list([cell.value for cell in sheet[137]][1:])
            ...
            recreación_y_cultura = list([cell.value for cell in sheet[138]][1:])
            ...
            educación = list([cell.value for cell in sheet[139]][1:])
            ...
            restaurantes_y_hoteles = list([cell.value for cell in sheet[140]][1:])
