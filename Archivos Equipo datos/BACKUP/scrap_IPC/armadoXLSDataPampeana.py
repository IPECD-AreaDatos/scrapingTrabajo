...
class LoadXLSDataPampeana:
    def loadInDataBase(self, file_path, lista_fechas ,lista_region, valor_region ,lista_subdivision, lista_valores):
        ...
        try:
            ...
            nivel_general = list([cell.value for cell in sheet[69]][1:])
            ...
            alimento_y_bebidas_no_alcoholicas = list([cell.value for cell in sheet[70]][1:])
            ...
            bebidas_alcoholicas_y_tabaco = list([cell.value for cell in sheet[71]][1:])
            ...
            vivienda_agua_electricidad_gas_y_otros_combustibles = list([cell.value for cell in sheet[73]][1:])
            ...
            equipamiento_y_mantenimiento_del_hogar = list([cell.value for cell in sheet[74]][1:])
            ...
            salud = list([cell.value for cell in sheet[75]][1:])
            ...
            transporte = list([cell.value for cell in sheet[76]][1:])
            ...
            comunicación = list([cell.value for cell in sheet[77]][1:])
            ...
            recreación_y_cultura = list([cell.value for cell in sheet[78]][1:])
            ...
            educación = list([cell.value for cell in sheet[79]][1:])
            ...
            restaurantes_y_hoteles = list([cell.value for cell in sheet[80]][1:])
