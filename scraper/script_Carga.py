...
excel_file = 'C:\\Users\\Usuario\\Desktop\\Documentos\\diccionario_cod_depto.xlsx'

# Nombre de la tabla en MySQL
table_name = 'localidades'

# Leer el archivo de Excel
df = pd.read_excel(excel_file) #Data Frame//Libreria de Panda
...
# Insertar los datos del archivo de Excel en la tabla
